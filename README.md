...
## 2. Objectives
   - Analyze voter turnout across districts and local bodies  
   - Study party-wise,gender-wise and region-wise performance  
...
## 3. Dataset
   ...
   - Includes:
     ...
     - District and local body level details
...
## 6. Key Insights
   ...
   - Clear dominance of major political fronts in specific local bodies  
